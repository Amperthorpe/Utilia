        ...
        public static void handle(final ClickActionMessage msg, final Supplier<NetworkEvent.Context> contextSupplier)
        {
            ...
            if (context.getDirection().equals(NetworkDirection.PLAY_TO_CLIENT))
            {
                context.enqueueWork(() -> {
                    ...
                    final PlayerEntity sender = Utilia.proxy.getPlayer();
                    if (sender == null) {
                        return;
                    }
                    ...
                    if(sender.containerMenu instanceof CreativeScreen.CreativeContainer) {
...
//                        item = sender.containerMenu.getSlot(msg.slot).getStack();
                    }

//                    if(item.getItem() instanceof IClickable)
//                    {
//                        ((IClickable) item.getItem()).onClick(sender, item, sender.containerMenu, msg.slot);
//                    }
            ...
            else if (context.getDirection().equals(NetworkDirection.PLAY_TO_SERVER))
            {
                context.enqueueWork(() -> {
                    ...
                    ItemStack item;
//                    if(sender.containerMenu instanceof PlayerContainer) {
//                        if(msg.slot < sender.inventory.mainInventory.size())
//                            item = sender.containerMenu.getSlot(msg.slot).getStack();
//                        else
//                            item = sender.inventory.armorInventory.get(msg.slot-sender.inventory.mainInventory.size());
...
//                    if(item.getItem() instanceof IClickable)
//                    {
//                        Boolean result = ((IClickable) item.getItem()).onClick(sender, item, sender.containerMenu, msg.slot);
